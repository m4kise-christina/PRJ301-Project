<%-- 
    ...
    Created on : Jul 2, 2023, 10:33:57 PM
    Author     : Sy
--%>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-sidebar">
                            ...
                            <form method="post" action="ControllerProduct">
                    ...
                    <div class="col-md-8">
                        <div class="product-content-right">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <%
                        Product pro=(Product)request.getAttribute("searched");
                        ...
                        int initial_quantity=daoI.getQuantityByID(pro.getProductID());
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="single-shop-product">
                                            <div>
                                                <img style="height: auto;width: auto" src="img/<%=pro.getProductID()%>.png" alt="error">
                                            </div>
                                            <h2 class="text-center"><%=pro.getProductName()%></h2>
                                            <div class="product-carousel-price text-center">
                                                <ins>$<%=displayPrice%></ins> <del>$<%=pro.getPrice()%></del>
                                            </div>  

                                            <div style="margin-left: 60px" class="product-option-shop">
                                                <%if(initial_quantity!=0){%>
                                                <a class="add_to_cart_button" rel="nofollow" href="ControllerCart?service=add&id=<%=pro.getProductID()%>">Add to cart</a>
                                                <%}else{%>
                                                <a style="background-color: red; margin-left: 75px" class="add_to_cart_button" rel="nofollow" href="#"><del>Add to cart</del></a>
                                                <%}%>
                                            </div>                       
                                        </div>
                                    </div>
